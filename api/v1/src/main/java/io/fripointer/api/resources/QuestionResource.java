...
public class QuestionResource {
    ...
    public Response createQuestion(Question question) {
        ...
        URI createdUri = uriInfo.getBaseUriBuilder().path("questions").path(newQuestion.getId()).build();
        return Response.created(createdUri).entity(newQuestion).build();
    }
    ...
    public Response updateQuestion(@PathParam("id") String id, Question question) {
        ...
        URI updatedUri = uriInfo.getBaseUriBuilder().path("questions").path(updatedQuestion.getId()).build();
        return Response.ok(updatedQuestion).location(updatedUri).build();
    }
