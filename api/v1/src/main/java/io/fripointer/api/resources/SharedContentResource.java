...
public class SharedContentResource {
    ...
    public Response createSharedContent(SharedContent sharedContent){
        ...
        URI createdUri = uriInfo.getBaseUriBuilder().path("shared-contents").path(newSharedContent.getId()).build();
        return Response.created(createdUri).entity(newSharedContent).build();
    }
    ...
    public Response updateSharedContent(@PathParam("id") String id, SharedContent sharedContent){
        ...
        URI updatedUri = uriInfo.getBaseUriBuilder().path("shared-contents").path(updatedSharedContent.getId()).build();
        return Response.ok(updatedSharedContent).location(updatedUri).build();
    }
